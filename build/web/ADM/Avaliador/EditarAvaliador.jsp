<%-- 
    Document   : EditarAvaliador
    Created on : 04/06/2018, 20:48:22
    Author     : Douglas
--%>
...
<html>
    ...
    <body>
       <div class="fullscreen_bg">
        ...
        <%
            Avaliador ava = (Avaliador)request.getAttribute("avaliador");
        %>
        <div class="container">
            <form action="${path}/EditarAvaliador" method="POST" class="form-inline">
                <div class="modal-header">
                    <h2 class="modal-title" style="color: cornsilk">
                        <center>Editar Avaliador</center>
                    </h2>
                </div>
                <div class="modal-body">
                 <input type="hidden" name="idA" value="<%=ava.getId()%>" /> 
                <br>
                <label style="color: cornsilk">
                    Nome:
                </label>
                <input class="form-control"  type="text" name="txtnome" value="<%=ava.getNome()%>" required="Preecha"/><br><br>
                <label style="color: cornsilk">
                    Telefone:
                </label>
                <input class="form-control"  type="text" name="txttelefone" value="<%=ava.getTelefolone()%>" required="Preecha"/><br><br>
                <label style="color: cornsilk">
                    CPF:
                </label>
                <input class="form-control"  type="text" name="txtcpf" value="<%=ava.getCpf()%>" required="Preecha"/><br><br>
                <label style="color: cornsilk">
                    Data Nasc:
                </label>
                <input class="form-control"  type="date" name="txtdata" value="<%=ava.getData_nasc()%>" required="Preecha"/><br><br>
                <label style="color: cornsilk">
                    Sexo:
                </label><select class="form-control"  name="txtsexo">
                    <option><%=ava.getSexo()%></option>
                    <option>Masculono</option>
                    <option>Femenino</option>
                </select><
                </div>
                <div class="modal-footer">
                    <a href="${path}/ListarAvaliador">
