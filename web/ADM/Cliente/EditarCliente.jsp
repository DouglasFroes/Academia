<%-- 
    ...
    Created on : 04/06/2018, 20:48:51
    Author     : Douglas
--%>
...
<html>
    ...
    <body>
        ...
        %>
        <div class="container">
        <form action="${path}/EditarCliente" method="POST" class="form-inline">
            ...
            <div class="modal-body">
                <input type="hidden" name="idC" value="<%=clie.getId()%>" /> 
                <br>
                <label style="color: cornsilk">
                    Nome:
                </label>
                <input class="form-control" type="text" name="txtnome" value="<%=clie.getNome()%>" required="Preecha"/><br><br>
                <label style="color: cornsilk">
                    Login:
                </label>
                <input class="form-control" type="text" name="txtlogin" value="<%=clie.getLogin()%>" required="Preecha"/><br><br>
                <label style="color: cornsilk">
                    Senha:
                </label>
                <input class="form-control" type="text" name="txtsenha" value="<%=clie.getSenha()%>" required="Preecha"/><br><br>
                <label style="color: cornsilk">
                    Telefone:
                </label>
                <input class="form-control" type="text" name="txttelefone" value="<%=clie.getTelefolone()%>" required="Preecha"/><br><br>
                <label style="color: cornsilk">
                    CPF:
                </label>
                <input class="form-control cpf" type="text" name="txtcpf" value="<%=clie.getCpf()%>" required="Preecha"/><br><br>
                <label style="color: cornsilk">
                    Endereço:
                </label>
                <input class="form-control" type="text" name="txtendereco" value="<%=clie.getEndereco()%>" required="Preecha"/><br><br>
                <label style="color: cornsilk">
                    Data Nasc:
                </label>
                <input class="form-control" type="date" name="txtdata" value="<%=clie.getData_nasc()%>" required="Preecha"/><br><br>
                <label style="color: cornsilk">
                    Sexo:
                </label>
                <select class="form-control" name="txtsexo">
                    <option><%=clie.getSexo()%></option>
                    <option>Masculono</option>
                    <option>Femenino</option>
                </select>
            </div>
            <div class="modal-footer">
                <a href="${path}/ListarCliente">
                    <button class="btn btn-default" style="width: 40%">
                           Cancelar    
                    </button>
                </a>
