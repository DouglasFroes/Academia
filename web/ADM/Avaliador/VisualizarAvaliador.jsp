<%-- 
    Document   : VisualizarAvaliador
    Created on : 05/06/2018, 20:58:44
    Author     : Douglas
--%>
...
<html>
    <head>
        ...
        <title>Visualizar Avaliador</title>
        <style>
            .fullscreen_bg {
                    position: absolute;
                    top: 0;
       ...
       <div class="fullscreen_bg">
        ...
        <table class="table table-dark table-bordered table-hover" style='border-color:blue;border-width: 1px; border-style: solid;'>
            <tr bgcolor="#BDB76B">
                ...
                <td style="width: 15%">Data nasc.</td>
           ...
           <tr bgcolor="#40D7BB">
                <td><%=ava.getNome()%></td>
                <td><%=ava.getData_nasc()%></td>
                <td><%=ava.getTelefolone()%></td>
                <td><%=ava.getCpf()%></td>
                <td><%=ava.getSexo()%></td>
        </tr>
        </table>
        ...
        <br><br>
         ...
         <hr />
         <div class="container">
        <h1><p>Avaliacao realizada<br></p></h1>
        
        <table class="table table-dark table-bordered table-hover" style='border-color:blue;border-width: 1px; border-style: solid;'>
            ¨<thead>
                <tr bgcolor="#BDB76B">
                    <td style="width: 20%">parciente</td>
                    <td style="width: 20%">Data</td>
                </tr>
            </thead>
            <tbody>
                <c:forEach var="fx" items="${listCon}" >
                <tr class="active">
                  <td>${fx.nome}</td>
                  <td>${fx.data}</td>
               </tr>
            ...
            <tfoot>
                <tr class="active">
                    <td colspan="2">Avalição realizadas:
                        <span id=>${listCon.size()}</span>
                    </td>
                </tr>
            </tfoot>
        </table>
